package page.app
{
	...
	public class AppImg2 extends LSprite
	{
		...
		public function AppImg2(bytes:ByteArray = null)
		{ 
			super();
			...
			_urlloader.addEventListener(Event.COMPLETE,loadImg2Over);
			_urlloader.dataFormat = URLLoaderDataFormat.BINARY;
			_urlloader.load(new URLRequest(Global.appPath+"/img.limg2"));
			
		}
		private function loadImg2Over(event:Event):void{
			_urlloader.die();
			_urlloader = null;
