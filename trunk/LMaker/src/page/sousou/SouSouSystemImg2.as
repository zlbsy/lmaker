package page.sousou
{
	...
	public class SouSouSystemImg2 extends LSprite
	{
		...
		public function SouSouSystemImg2(bytes:ByteArray = null)
		{ 
			super();
			...
			if(!Global.exists(Global.sousouPath+"/images","sys.limg2")){
				trace("new");
				...
				bytes.compress();
				Global.saveBytesData(Global.sousouPath + "/images","sys.limg2",bytes);
			}
			_urlloader = new LURLLoader();
			_urlloader.addEventListener(Event.COMPLETE,loadStrategyImgOver);
			_urlloader.dataFormat = URLLoaderDataFormat.BINARY;
			_urlloader.load(new URLRequest(Global.sousouPath+"/images/sys.limg2"));
